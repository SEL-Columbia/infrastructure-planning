...
def estimate_electricity_production_cost(**keywords):
    ...
    solar_mini_grid_system_loss_as_percent_of_total_production = keywords[
    ...
    d['electricity_production_in_kwh_by_year'] = adjust_for_losses(
        ...
        solar_mini_grid_system_loss_as_percent_of_total_production / 100.)
...
def estimate_solar_mini_grid_battery_cost(
        ...
        solar_mini_grid_battery_raw_cost_per_kwh,
